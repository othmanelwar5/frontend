const products = {
    "d3-k2-gummies": {
        ...
        painPoints: [
            { problem: "أغلبنا في السعودية يقضي وقته في المكاتب أو أماكن مغلقة بعيد عن شمس الصباح.", solution: "حلوى ميزاني تعطيك جرعتك اليومية من D3 لتعويض نقص الشمس." },
            { problem: "الكبسولات الكبيرة مزعجة وتخليك توقف الروتين بعد كم يوم.", solution: "حلوى لذيذة بطعم الفواكه، تخليك تنتظر وقتها كل يوم وتلتزم فيها." },
            { problem: "الخمول المستمر والإحساس بالإرهاق بدون سبب واضح يأثر على إنجازك.", solution: "تركيبة D3+K2 تدعم مستويات الطاقة الطبيعية في جسمك." }
        ],
    ...
    "sleep-tea": {
        ...
        painPoints: [
            { problem: "زحمة الشوارع وضغط الدوام يخلي أعصابك مشدودة حتى وقت النوم.", solution: "الأشواغاندا تساعد على خفض الكورتيزول وتهدئة الأعصاب طبيعياً." },
            { problem: "تنسدح على السرير وتبدأ دوامة التفكير في مهام بكرا.", solution: "المغنيسيوم يعمل كمهدئ طبيعي للناقلات العصبية ليوقف دوامة التفكير." },
            { problem: "تخاف من حبوب المنومات اللي تسبب إدمان وتخليك تصحى دايخ.", solution: "مكونات طبيعية 100%، لا تسبب التعود، وتصحيك بنشاط." }
        ],
    ...
    "probiotic-fiber-gummies": {
        ...
        painPoints: [
            { problem: "بعد بعض الوجبات تحس بانتفاخ وثقل يخليك ودك بس تنسدح.", solution: "البروبيوتيك يعيد توازن بكتيريا الأمعاء لتخفيف الغازات المزعجة." },
            { problem: "نمط الأكل السريع وقلة الألياف في نظامنا تخرب توازن الهضم.", solution: "ألياف حيوية (Prebiotics) تغذي البكتيريا النافعة وتدعم حركة الأمعاء." },
            { problem: "الالتزام بخلطات الألياف أو حبوب البكتيريا المتعبة مو عملي للمدى الطويل.", solution: "قطعة حلوى واحدة بعد الوجبة، لذيذة وعملية جداً." }
        ],
        trustTags: ["خالي من الجلوتين", "نباتي 100%", "بدون سكر مضاف", "ألوان طبيعية"],
        ingredients: [
