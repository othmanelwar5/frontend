const products = {
    "d3-k2-gummies": {
        ...
        headline: "تخلص من الخمول وارفع طاقتك اليومية — بقطعة حلوى واحدة",
        subheading: "حلوى يومية لذيذة مصممة لروتينك المزدحم. تعوضك عن قلة التعرض للشمس وتدعم نشاطك ومناعتك بكل سهولة، بدون كبسولات مزعجة.",
        eyebrow: "روتين النشاط والطاقة",
        label: "D3 + K2",
        chips: ["طاقة مستدامة", "عظام أقوى", "مناعة", "لذيذة وسهلة"],
        painTitle: "هل تعاني من الخمول المستمر رغم نومك الكافي؟",
        painPoints: [
            { problem: "أغلبنا في السعودية يقضي وقته في المكاتب أو أماكن مغلقة بعيد عن شمس الصباح، والنتيجة؟ نقص حاد في فيتامين د.", solution: "حلوى ميزاني تعطيك جرعتك اليومية المثالية من D3 لتعويض نقص الشمس فوراً." },
            { problem: "الكبسولات الكبيرة مزعجة وتخليك توقف الروتين بعد كم يوم لأنك تنسى أو تمل.", solution: "حلوى لذيذة بطعم الفواكه الطبيعية، تخليك تنتظر وقتها كل يوم وتلتزم فيها بدون ملل." },
            { problem: "الخمول المستمر، الإحساس بالإرهاق بدون سبب واضح، وآلام العظام الخفيفة تأثر على إنجازك.", solution: "تركيبة D3+K2 المدروسة تدعم مستويات الطاقة الطبيعية في جسمك وتوجه الكالسيوم للعظام." }
        ],
        trustTags: ["خالي من الجلوتين", "نباتي 100%", "بدون سكر مضاف", "ألوان طبيعية"],
        ingredients: [
    ...
    "sleep-tea": {
        ...
        headline: "أوقف دوامة التفكير وادخل في نوم عميق — بدون منومات تسبب الإدمان",
        subheading: "مزيج الأشواغاندا والمغنيسيوم يرسل إشارة واضحة لجسمك: انتهى وقت التوتر، وبدأ وقت الراحة والنوم العميق.",
        eyebrow: "روتين الهدوء قبل النوم",
        label: "Sleep Tea",
        chips: ["هدوء فوري", "نوم أعمق", "مغنيسيوم", "أشواغاندا"],
        painTitle: "جسمك منهك.. بس عقلك يرفض يوقف تفكير؟",
        painPoints: [
            { problem: "زحمة الشوارع وضغط الدوام يخلي أعصابك مشدودة حتى وقت النوم، وتحس إنك مو قادر تفصل.", solution: "الأشواغاندا (عشبة الاسترخاء) تساعد على خفض الكورتيزول وتهدئة الأعصاب طبيعياً." },
            { problem: "تنسدح على السرير وتبدأ دوامة التفكير في مهام بكرا، وتتقلب ساعات بدون فايدة.", solution: "المغنيسيوم يعمل كمهدئ طبيعي للناقلات العصبية ليوقف دوامة التفكير ويرخي عضلاتك." },
            { problem: "تخاف من حبوب المنومات اللي تسبب إدمان وتخليك تصحى دايخ ومصدع اليوم الثاني.", solution: "مكونات طبيعية 100%، لا تسبب التعود، وتضمن لك نوم مريح وتصحيك بنشاط وطاقة." }
        ],
        trustTags: ["خالي من الكافيين", "نباتي 100%", "بدون سكر مضاف", "لا يسبب التعود"],
        ingredients: [
    ...
    "probiotic-fiber-gummies": {
        ...
        headline: "تخلص من الانتفاخ وثقل المعدة المزعج — بقطعة حلوى واحدة بعد الأكل",
        subheading: "حلوى البروبيوتيك والألياف مصممة لدعم توازن بكتيريا الأمعاء، وتقليل الانزعاج اليومي والغازات بطريقة سهلة ولذيذة جداً.",
        eyebrow: "روتين الراحة بعد الأكل",
        label: "Probiotic + Fiber",
        chips: ["هضم مريح", "توازن الأمعاء", "بدون انتفاخ", "ألياف"],
        painTitle: "تعبت من إحساس الانتفاخ والغازات بعد كل وجبة؟",
        painPoints: [
            { problem: "بعد بعض الوجبات (خصوصاً الكبسة أو الفاست فود) تحس بانتفاخ وثقل يخليك ودك بس تنسدح.", solution: "البروبيوتيك يعيد توازن بكتيريا الأمعاء لتسريع الهضم وتخفيف الغازات المزعجة فوراً." },
            { problem: "نمط الأكل السريع وقلة الألياف في نظامنا الغذائي تخرب توازن الهضم وتسبب إمساك أو انزعاج.", solution: "ألياف حيوية (Prebiotics) تغذي البكتيريا النافعة وتدعم حركة الأمعاء الطبيعية والمريحة." },
            { problem: "الالتزام بخلطات الألياف السيئة أو حبوب البكتيريا المتعبة مو عملي للمدى الطويل وتنساه بسرعة.", solution: "قطعة حلوى واحدة بعد الوجبة، لذيذة وعملية جداً، وتغنيك عن كل الخلطات المعقدة." }
        ],
        trustTags: ["خالي من الجلوتين", "نباتي 100%", "بدون سكر مضاف", "ألوان طبيعية"],
        ingredients: [
